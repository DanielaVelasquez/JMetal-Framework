...
public class HarmonySearch
    ...
    public String getDescription() {
        return " Harmony Search " + " PAR : " + PAR + " BW: " + BW + " HMCR: " + HMCR + "\n Evaluations " + super.getEvaluations();
    }
    ...
    /**
     *
     * @return bestSolution,is the best solution in Harmonic memory
     */
    @Override
    ...
    public void pitchAdjustment(int varIndex) {
        ...
        if (rand <= 0.5) {
            ...
            if (temp < NCHV.getUpperBound(varIndex)) {
                NCHV.setVariableValue(varIndex, temp);
            }
        } else {
            temp -= randomGenerator.nextDouble(NCHV.getLowerBound(varIndex), NCHV.getUpperBound(varIndex)) * BW;
            if (temp > NCHV.getLowerBound(varIndex)) {
                NCHV.setVariableValue(varIndex, temp);
            }
        }
    ...
    public void setRandonGenerator(JMetalRandom rnd) {
        ...
        setRandomGeneratorReference(randomGenerator);
    }
